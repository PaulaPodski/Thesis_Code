...
plot(roc_curve_knn, col = "blue", main = "ROC Curve: 80/20 Split, KNN Imputation", print.auc = TRUE)
...
plot(roc_curve_mean, col = "blue", main = "ROC Curve: 80/20 Split, Mean Imputation", print.auc = TRUE)
abline(a = 0, b = 1, lty = 2, col = "red")
dev.off()
